...
SECRET_KEY = 'django-insecure-_k(1x$su0g&81c=v+lr-=dceq=f&mu1wot0&ph0-#)+$amh-39'
...
SESSION_COOKIE_SAMESITE = "Lax"   # local
SESSION_COOKIE_SECURE = False     # en prod True con HTTPS
# ...
